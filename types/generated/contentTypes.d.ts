...
export interface ApiProjectProject extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    ImageRatio: Schema.Attribute.Enumeration<
      ['Aspect-Ratio-3:2', 'Aspect-Ratio-3:4']
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    Photography: Schema.Attribute.String;
    ProjectTeam: Schema.Attribute.Text;
    publishedAt: Schema.Attribute.DateTime;
    RenderedServices: Schema.Attribute.Text;
...
export interface ApiServiceService extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    Sevices: Schema.Attribute.Blocks;
    SubTitle: Schema.Attribute.String;
    Title: Schema.Attribute.Text;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiSiteSettingSiteSetting extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    ShopLtkUrl: Schema.Attribute.String;
    SiteIconLogo: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
...
export interface ApiTeamTeam extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::team.team'> &
      Schema.Attribute.Private;
    Member: Schema.Attribute.Component<'team-member.team-member', true>;
    Photography: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    TopMember: Schema.Attribute.Component<'team-member.team-member', true>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiTvShowTvShow extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    VideoUrl: Schema.Attribute.Component<'video-url.video-url', true>;
  };
}
